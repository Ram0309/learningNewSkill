...
test.describe('UI Automation Utilities Demo', () => {
  let uiUtils: EnhancedUIUtils;
  let browserUtils: BrowserUtils;
  let assertionUtils: AssertionUtils;

  test.beforeEach(async ({ page, context, browser }) => {
    uiUtils = new EnhancedUIUtils(page, context);
    browserUtils = new BrowserUtils(page, context, browser);
    assertionUtils = new AssertionUtils(page);
  });

  test('Demo: Screenshot Utilities', async ({ page }) => {
  ...
  test('Demo: Dropdown Utilities', async ({ page }) => {
  ...
  test('Demo: Checkbox and Radio Button Utilities', async ({ page }) => {
    await page.goto('https://demowebshop.tricentis.com/register');
  ...
  test('Demo: Input Field Utilities', async ({ page }) => {
    await page.goto('https://demowebshop.tricentis.com/register');
    ...
    const testEmail = DataUtils.generateRandomEmail('testdomain.com');
  ...
  test('Demo: Window Management Utilities', async ({ page, context }) => {
  ...
  test('Demo: Wait Utilities', async ({ page }) => {
  ...
  test('Demo: Scroll and Hover Utilities', async ({ page }) => {
  ...
  test('Demo: Browser Utilities', async ({ page, context, browser }) => {
  ...
  test('Demo: Data Utilities', async () => {
    ...
    // Validate data
    const isValidEmail = DataUtils.validateEmail(randomEmail);
    const isValidPhone = DataUtils.validatePhoneNumber(randomPhone);
    const isValidDate = DataUtils.validateDate(randomDate.toISOString());
    ...
    const csvData = DataUtils.jsonToCSV(testData);
    const backToJson = DataUtils.csvToJSON(csvData);
    
    console.log('CSV data:', csvData);
    console.log('Back to JSON:', backToJson);
    
    // Generate unique ID
    const uniqueId = DataUtils.generateUniqueId('TEST');
    console.log('Unique ID:', uniqueId);
  });

  test('Demo: Advanced Assertions', async ({ page }) => {
    await page.goto('https://demowebshop.tricentis.com/register');
    ...
    expect(softAssertionResults.passed).toBe(2);
    expect(softAssertionResults.failed).toBe(1);
  });

  test('Demo: Alert Handling', async ({ page }) => {
  ...
  test('Demo: Table Operations', async ({ page }) => {
  ...
  test('Demo: Keyboard Utilities', async ({ page }) => {
    await page.goto('https://demowebshop.tricentis.com/register');
  ...
  test('Demo: Performance Monitoring', async ({ page, context, browser }) => {
  ...
  test('Demo: Error Handling and Retry', async ({ page }) => {
    await page.goto('https://demowebshop.tricentis.com/register');
